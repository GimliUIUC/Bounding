...
%%
% --- parameters for eom ---
% xopt = [0.2811    0.0296    0.2066    0.2367    2.4988   30.3050];
xopt = [0.3 pi/12 0 0 0 20];

%X = [x   z  th     dx dz dth t_]
% ic = [0.2 0.25 pi/20 0.5 0  0 0]; % free fall
% ic = [0.2 0.2594    0.1513    0.2212   -0.0454    1.5769 0];
% ic = [0.2 0.2709    0.2006    0.3221   -0.0999    1.5620 0];
% ic = [0.2  0.2271    0.1555    0.2000   -0.2328    1.8872 0];
ic = [0.2 xopt(1:5) 0];
alpha_tau = xopt(6);
...
%% --------- visualize -----------
[t_even, X_even] = even_sample(tout,Xout,300);
...
figure
animate(t_even,X_even,teout, Xeout, params,control)
